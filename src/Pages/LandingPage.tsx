  ...
  return (
    <div>
      ...
      >
        ...
        <img src={founderImg} alt="" className="w-80 z-10 mx-auto" />
        <div className="flex flex-col gap-5 items-center z-10 justify-center text-center">
          <p className=" md:w-1/2 font-poppins text-lg md:text-2xl leading-10 text-white ">
            मेरे परिवार की सहायता से, और मेरे दोस्तों के समर्थन से, हम अपने
            संसाधनों का बेहतर उपयोग करने में सक्षम होंगे। हम एक स्टार्टअप
            फाउंडेशन हैं और सुधार करना और बेहतर सेवा करना सीख रहे हैं। हम आपके
            समर्थन और विचारों का स्वागत कर रहे हैं। यदि आपके पास इच्छाशक्ति है
            और वही सपने हैं तो आएं और हमारे साथ जुड़ें क्योंकि कोई भी योगदान
            बहुत मूल्यवान है।
          </p>
        </div>
      </div>
